...
public class HardcoreLeaderBoardFetcher : ILeaderBoardFetcher
{
    private readonly IBattleNetApiHttpClient battleNetApiHttpClient;
    private readonly int currentSeason;

    public HardcoreLeaderBoardFetcher(IBattleNetApiHttpClient battleNetApiHttpClient, int currentSeason)
    {
